...
public class Register_Farmer extends AppCompatActivity {
    ...
    EditText edit_name,edit_dob,edit_address,edit_lat,edit_long,edit_contact,edit_email,edit_adhar,edit_pan,edit_account,edit_ifsc,edit_branch,edit_bank,edit_password;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        edit_dob.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(Register_Farmer.this, date, myCalendar
        ...
        Login.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Register_Farmer.this,LoginActivity.class);
    ...
    private void Register_user() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLs.URL_register_farmer,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("FContact", String.valueOf(contact));
                params.put("FEmail", email);
                params.put("FAdhar", adhar);
                params.put("FPan", pan);
                params.put("FAccount",account );
                params.put("FIFSC", ifsc);
                params.put("FBranch", branch);
                params.put("FBank", bank);
                params.put("FPassword", cpassword);
                return params;
            }
        };
